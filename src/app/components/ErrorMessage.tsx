...
export default function ErrorMessage({
  ...
  message = "No pudimos generar tu plan financiero en este momento. Por favor, intenta de nuevo más tarde.",
  retry,
}: ErrorMessageProps) {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-16 text-center text-red-700">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 16 16"
        fill="currentColor"
        className="w-16 h-16 mb-6 text-red-600"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
